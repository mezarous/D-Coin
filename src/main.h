...
static const int64 MAX_MONEY = 100800 * COIN; // maximum of 100 800 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1 / 250; // 1 blocks found a day. Priority cutoff is 1 DCN day / 250 bytes.
    }
