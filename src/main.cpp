...
const string strMessageMagic = "D-Coin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // D-Coin: 1 days
static const int64 nTargetSpacing = 120; // D-Coin: 120 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal D-Coin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "D-Coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	//  nTime=1418014698, nBits=1e0ffff0, nNonce=2085386442, vtx=1)
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "The New World Order Will Rise December9....bwahahahaha!!!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1418014698;//epoch time december9
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085386442;

        if (fTestNet)
        {
            block.nTime    = 1418014698; //epoch time december 9
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // increase each by adding 2 to D-Coin's value.
